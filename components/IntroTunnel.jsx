...
const PHRASE = 'M J Group Of Co. · '; // tiled on all 4 walls
  ...
  return (
    <div className={"intro-tunnel intro-" + phase + (phase === "out" ? " intro-fade" : "")}>
      ...
      <div className="intro-center">
        <div className="intro-logo"><span>M J Group Of Co.</span><span>REALTY</span></div>
